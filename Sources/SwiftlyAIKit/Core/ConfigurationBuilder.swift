...
public class ConfigurationBuilder {
    ...
    public func enableSimpleLogging() -> Self {
        enableLogging(logRequests: true, logResponses: true, logFullBodies: false)
    }

    /// Enable verbose logging (includes full bodies)
    @discardableResult
    public func enableVerboseLogging() -> Self {
        enableLogging(logRequests: true, logResponses: true, logFullBodies: true)
    }
